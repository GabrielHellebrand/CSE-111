...
def main():
    ...
    formula = input("Enter the molecular formula of the sample you have? ")
    mass = float(input("Enter the mass in grams: "))
    dictionary = make_periodic_table()
    element_group = parse_formula(formula, dictionary)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for element in symbol_quantity_list:
        ...
        total_mass = total_mass + (atomic_mass * quantity)
